...
var QBrowser = new function () {
    ...
    this.QPay = new function () {
        ...
        /**
         * The secure format used to encrypt the transaction. Default is IDTech.
         * @memberof QPay
         */
        this.SecureFormat = {
            IDTECH: "idTech",
        ...
        this.TransactionBuilder = new function () {
             ...
             * @memberof TransactionBuilder
             * @param {string} amount - The amount to be sent to the payment device for charging. This should be a String so we dont lose any precision.
            ...
            /**
             * Optional: The format used to encrypt this transaction.
             * @memberof TransactionBuilder
             * @param {string} format - The secure format from SecureFormat.
             * @param {function} errorFunction 
             * @returns {TransactionBuilder}
             */
            this.secureFormat = function (format, errorFunction) {
                NativeCall("qpay.TransactionBuilder.secureFormat", [format], [errorFunction]);
                return QBrowser.QPay.TransactionBuilder;
            };
...
function GetFunctionName(name) {
    if (name && typeof name == "function") {
        if(name.toString().indexOf("function")> -1) 
        {name = name.toString()
